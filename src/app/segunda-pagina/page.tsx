        ...
        <>
            ...
            <div className="h-full bg-gray-900	">
                <div className="w-full flex items-center justify-center flex-col gap-4 ">
                    <h1 className="text-[35px] font-bold text-orange-600 p-5">Dragon Ball!</h1>
                    <div className="flex gap-2 items-center">
                        <label htmlFor=""><h3 className="text-orange-600"> Pesquisar:</h3></label>
                ...
                <div className="flex flex-wrap gap-5 w-full justify-center p-5 ">
                    ...
                    {personagem.map((item, index) =>{
                        return(
                            <div key={item.id} className=" h-90 w-80 border border-orange-600 bg-gray-800 p-5 flex flex-col gap-5 items-center justify-center rounded-lg transition duration-500 shadow-lg shadow-black-500/2  hover:scale-105">
